...
class ParamWidget : public QWidget {
 ...
 public:
   ...
   * emitted.
   */
  void AddEnum(const QString& name, const EnumVector& items, int initial_value,
   ...
   * @param display_hint must be either ParamWidget::kSlider or
   * ParamWidget::kSpinBox
   *
   * When the value of the parameter changes, the ParamChanged() signal is
   * emitted.
   */
  void AddInt(const QString& name, int min, int max, int step,
   ...
   * emitted.
   */
  void AddDouble(const QString& name, double min, double max, double step,
                 double initial_value, DisplayHint display_hint);
